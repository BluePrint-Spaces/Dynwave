...
public class ItemPoolNoodles extends Item {
    public ItemPoolNoodles(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ThrowablePoolNoodle snowballEntity = new ThrowablePoolNoodle(user,world);
